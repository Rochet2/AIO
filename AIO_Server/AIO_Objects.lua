...
function AIO.Object:AddMethod(MethodName, Func)
    ...
    if(MethodHandle[MethodName]) then
        ...
        self[MethodName] = Func or function (self, ...)
            self:AddBlock("Method", self:GetName(), AIO:GetFuncId(MethodName), ...)
        end
    end
end
...
function AIO.Object:AddMethods(tbl)
    ...
    for k,v in ipairs(tbl.GetSet_Methods or {}) do
        ...
        self:AddMethod("Set"..v,
            function(self, ...)
                self:SetData(v, ...)
                self:AddBlock("Method", self:GetName(), AIO:GetFuncId("Set"..v), ...)
            end
        )
    end
end
...
function MethodHandle.CreateFontString(self, name, layer, template, ...)
    ...
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("CreateFontString"), name, layer, template, ...)
    return fontstr
end
function MethodHandle.CreateTexture(self, name, layer, template, ...)
    ...
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("CreateTexture"), name, layer, template, ...)
    return texture
end
...
function MethodHandle.CreateAnimationGroup(self, name, template, ...)
    ...
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("CreateAnimationGroup"), name, template, ...)
    return group
end
...
function MethodHandle.RegisterEvent(self, event, ...)
    ...
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("RegisterEvent"), event, ...)
end
function MethodHandle.UnregisterEvent(self, event, ...)
    self.RegisteredEvents[event] = nil
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("UnregisterEvent"), event, ...)
end
...
function MethodHandle.SetParent(self, newparent, ...)
    ...
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("SetParent"), newparent, ...)
end
function MethodHandle.SetEnabledKeyboard(self, ...)
    self:SetData("EnabledKeyboard", ...)
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("EnableKeyboard"), ...)
end
function MethodHandle.SetEnabledMouse(self, ...)
    self:SetData("EnabledMouse", ...)
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("EnableMouse"), ...)
end
function MethodHandle.SetEnabledMouseWheel(self, ...)
    self:SetData("EnabledMouseWheel", ...)
    self:AddBlock("Method", self:GetName(), AIO:GetFuncId("EnableMouseWheel"), ...)
end
